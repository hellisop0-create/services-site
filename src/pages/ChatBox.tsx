      ...
      <div className="bg-white border-t border-gray-100 p-4 shrink-0">
        <div className="max-w-4xl mx-auto flex items-center gap-3">
          <input
            ...
            className="flex-1 p-3 bg-gray-50 border border-gray-200 rounded-2xl outline-none focus:bg-white focus:border-blue-400 transition-all text-sm"
          />

          <button
            onClick={sendMessage}
            disabled={!input.trim()}
            className="bg-blue-600 text-white p-3 rounded-2xl hover:bg-blue-700 transition-all disabled:opacity-40 shadow-md shadow-blue-100 flex items-center justify-center shrink-0"
          >
            <Send size={20} />
          </button>
        </div>
